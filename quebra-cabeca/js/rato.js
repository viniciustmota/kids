...
function clickPeca1(){
    pecaLogica(".peca1-in","imgs/rato/rato-base2.png", "peca2-in", "peca1-in", $("#peca1"))
}

function clickPeca2(){
    pecaLogica(".peca2-in","imgs/rato/rato-base3.png", "peca3-in", "peca2-in", $("#peca2"))
}

function clickPeca3(){
    pecaLogica(".peca3-in","imgs/rato/rato-base4.png", "peca4-in", "peca3-in", $("#peca3"))
}

function clickPeca4(){
    pecaLogica(".peca4-in","imgs/rato/rato-base.png", "","",$("#peca4"))
    setTimeout(() => {
